...
import 'package:nexus_media_downloader/main.dart';

void main() {
  testWidgets('App basic UI test', (WidgetTester tester) async {
    // Build our app and trigger a frame.
    await tester.pumpWidget(const NexusMediaDownloaderApp(
      showWalkthrough: false,
      hasAcceptedLegal: true,
    ));

    // Verify that our title is present.
    expect(find.text('Nexus Media Downloader'), findsOneWidget);
